...
int main() {
    ...
    // 3. Compile the program with appropriate architecture flag
    ...
    // 5. Get the compiled code size and code
    size_t code_size;
    ...
    // Get and dump LLVM Bitcode (Requires separate compilation with -fgpu-rdc)
    {
        ...
        hiprtcResult res_ir = hiprtcCompileProgram(prog_ir, 2, opts_ir);
        if (res_ir == HIPRTC_SUCCESS) {
            size_t bitcode_size;
    ...
    // 7. Load module from compiled binary data
    hipModule_t module;
